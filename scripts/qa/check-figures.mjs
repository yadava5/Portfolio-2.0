...
const FIGURES = [
  ...
  },
  {
    ...
    source: "`pytest tests -q` at head 0f2b63f, 2026-08-02 — 278 passed, 10 skipped",
  },
  {
    figure: "Glyph · MNIST accuracy",
    run: /97\.01%/,
    data: /97\.01/,
    source: "committed eval at GLYPH_EVAL_SHA; regenerated byte-identical 2026-08-02",
  },
     ...
     reader's discovery. */
  {
    ...
    run: /1,168 passed · 11 skipped/,
    data: /1,168 tests passing under vitest, with 11 skipped/,
    source:
      "both vitest configs at head 932625e, 2026-08-02 — 635 frontend + 533 backend",
  },
  {
    figure: "Cadence · suite split",
    run: /635 fe \+ 533 be/,
    data: /635 frontend \+ 533 backend/,
