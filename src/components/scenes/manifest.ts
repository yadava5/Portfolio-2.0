 ...
 *   nlp node; 1,168 tests (635 frontend + 533 backend, vitest) from
...
export const PROJECT_SCENE_MANIFEST: Record<string, ProjectSceneMeta> = {
  ...
  "taskflow-calendar": {
    ...
    provenance:
      "chrono-node + compromise · google meet — multi-attendee invites · 1,168 tests passing — cadence @ 932625e",
